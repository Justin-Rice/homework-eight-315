var MODEL = (function(){
 ...
 var _yourRecipe = function(){
    $.each(USER_RECIPES, function(index, recipe){
      ...
      //   background-size: cover;"></div>
      //   <div class="recipe__info">
      //     <div class="name">pain${USER_RECIPES[index].recipeName}</div>
      //     <div class="description">${USER_RECIPES[index].recipeDescription}</div>
      //     <div class="prep">
      //       <div class="time">
      //         <img src="../img/time.svg">
      ...
      //       <div class="servings">
      //         <img src="../img/servings.svg">
      //         <div class="servings__info"> ${USER_RECIPES[index].recipeServings} servings</div>
      //       </div>
      //     </div>
      //   </div>
      // </div>
      ...
      $("#your-flex").append("jkbdkbdjksajkdnkj")
      console.log("wacj")
    });
